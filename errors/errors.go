...
type vientianeCrawlerError struct {
	// errType 代表错误的类型。
	errType ErrorType
	// errMsg 代表错误的提示信息。
	errMsg string
...
func (ce *vientianeCrawlerError) Type() ErrorType {
	return ce.errType
}

func (ce *vientianeCrawlerError) Error() string {
	if ce.fullErrMsg == "" {
		ce.genFullErrMsg()
	}
...
func (ce *vientianeCrawlerError) genFullErrMsg() {
