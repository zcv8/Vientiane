...
type vientianeSchedSummary struct {
...
func (ss *vientianeSchedSummary) Struct() SummaryStruct {
	registrar := ss.sched.register
...
func (ss *vientianeSchedSummary) String() string {
...
func newSchedSummary(
	...
	dataArgs DataArgs,
	moduleArgs ModuleArgs,
	sched *vientianeScheduler) SchedSummary {
	if sched == nil {
		return nil
	}
	return &vientianeSchedSummary{
		requestArgs: requestArgs,
		dataArgs:    dataArgs,
		moduleArgs:  moduleArgs,
		sched:       sched,
